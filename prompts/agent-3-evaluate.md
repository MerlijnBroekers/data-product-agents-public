# Prompt: Agent 3 — Improvement Plan — Part 2: Plan

> **This is Part 2.** Paste everything below this line into the **same conversation** after providing your annotated findings, Agent 2 output, and optional contracts in Part 1. Do not start a new conversation — your inputs are already in this conversation's context.

---

> **You now have all inputs from this conversation. Build the improvement plan immediately. Do not ask for inputs again.**
