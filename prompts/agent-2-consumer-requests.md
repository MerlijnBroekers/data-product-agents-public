# Prompt: Agent 2 — Consumer Requests

> Copy everything below the line into any LLM (ChatGPT, Claude, Gemini, etc.) to run this agent. This is the plain-prompt equivalent of the `/agent-2-consumer-requests` skill in this repo.
>
