---
name: agent-1-p1-domain-language
description: "Agent 1-P1 — Domain Language: evaluate data contracts against Principle 1 (use your domain language, consistently)."
version: 1.1.0
---
...
>
> Once all Team Review blocks are filled in, those annotated findings — along with the output of `/agent-2-consumer-requests` — are the inputs to `/agent-3-improvement-plan`.
