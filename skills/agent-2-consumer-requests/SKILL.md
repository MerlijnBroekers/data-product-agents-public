...
description: "Agent 2 — Consumer Advocate: analyse SQL query patterns against data contracts and generate consumer-voiced contract change requests."
version: 2.1.0
---
...
Present the findings in this format. This output will be used by `/agent-3-improvement-plan` — ask the user to save it.
...
> This is the Agent 2 consumer analysis. Save this output — it is one of the two inputs to `/agent-3-improvement-plan` (the other is your annotated principle findings from the Agent 1 skill(s) you ran).
