---
name: agent-0-setup
description: "Agent 0 — Start Here: introduces the Data Product Agents workflow and explains what inputs to prepare for each agent."
version: 2.1.0
---
...
This plugin evaluates your data contracts against four Data Product Principles derived from Domain-Driven Design. It produces a phased, risk-ordered improvement plan that your producer team can act on immediately.
...
**Agent 2 output** — the consumer recommendations produced by `/agent-2-consumer-requests`.
